...
\begin{itemize}
	\item{The query set Q1 is defined as Q1 = ($\sigma$,P,$\sigma_{0}$) where $\sigma_{0}$ is the initial state, $\sigma$ is the resulting state from the execution of program P and P is a sequence defined as P = (A1,...,An), n $\geq$ 0 of Ac and $\sigma$, $\sigma_{0}$ $\in$ $\sum$ }
	\item{The Query set Q2 is defined as Q2=(C,P) where C is the cost to execute the program P and P is a sequence defined as P=(A1,....,An), n $\geq$ 0 of Ac}
\end{itemize}
