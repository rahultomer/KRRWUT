...
\subsection{Statements :}\label{sec:Statements} 
  ...
  \centering
    ...
    \hline
    Cost Statement & Ai costs ki, ki $\in$ K for i = 1,...,n & If the action Ai is performed in any state satisfying $\overline{g1}$, ...,$\overline{gk}$ , then change in state results in fixed cost ki. \\
    \hline
    \end{tabular}
