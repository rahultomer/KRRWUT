...
\begin{itemize}
\item{State query:\\
necessary $\sigma$ after A1,...,Ai on $\sum$ \\
possibly $\sigma$ after A1,....,Ai on $\sum$ \\
\\
The first statement says that state $\sigma$ always occurs after performing every action in specific state on $\sum$ \\
The second statement says that state $\sigma$ may occurs after performing every action in specific state on $\sum$ \\
When the option from $\sum$ is omitted, these queries refer to the initial state \\}
\\
\item{Cost query: \\
necessary execution costs ki after A1, ..., Ai on $\sum$ \\
possibly execution costs 0 after A1, ..., Ai on $\sum$ \\
\\
The first statement says that corresponding ki cost will always occur after performing every action in a specific state on $\sum$. \\
The second statement says that 0 cost may occur after performing every action in a specific state on $\sum$.\\
When the option from $\sum$ is omitted, these queries refer to the initial state. \\}
\end{itemize}
	...
	possibly $\sigma_{0}$ after buy on $\sigma_{0}$\\
	necessary $\sigma_{0}$ after buy on $\sigma_{1}$\\
	possibly $\sigma_{2}$ after travel on $\sigma_{2}$\\
	necessary $\sigma_{1}$ after travel on $\sigma_{0}$\\
	\\
	possibly execution costs 0 after buy on $\sigma_{0}$\\
	necessary execution costs 40 after buy on $\sigma_{2}$\\
	possibly execution costs 0 after travel on $\sigma_{2}$\\
	necessary execution costs 50 after travel on $\sigma_{0}$\\
	...
	\subsubsection{Queries}
	possibly $\sigma_{0}$ after buy on $\sigma_{0}$\\
	necessary $\sigma_{2}$ after buy on $\sigma_{1}$\\
	possibly $\sigma_{1}$ after order on $\sigma_{1}$\\
	necessary $\sigma_{1}$ after order on $\sigma_{0}$\\
	\\
	possibly execution costs 0 after buy on $\sigma_{0}$\\
	necessary execution costs 200 after buy on $\sigma_{1}$\\
	possibly execution costs 0 after order on $\sigma_{1}$\\
	necessary execution costs 50 after order on $\sigma_{0}$\\
	...
	\end{figure}
	\subsubsection{Queries}
	possibly $\sigma_{0}$ after eat on $\sigma_{0}$\\
	necessary $\sigma_{1}$ after cook on $\sigma_{0}$\\
	possibly $\sigma_{0}$ after play on $\sigma_{0}$\\
	necessary $\sigma_{3}$ after eat on $\sigma_{1}$\\
	\\
	possibly execution costs 0 after eat on $\sigma_{0}$\\
	necessary execution costs 15 after cook on $\sigma_{0}$\\
	possibly execution costs 20 after play on $\sigma_{2}$\\
	necessary execution costs 5 after eat on $\sigma_{1}$\\
	\newpage
	\section{Appendix}	
	\begin{appendix}
		\listoffigures
